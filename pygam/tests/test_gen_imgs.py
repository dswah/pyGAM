...
def test_faithful_data_poisson():
    """
    Test that faithful_data_poisson function executes without error and calls plt.savefig
    with the correct filename and dpi parameters for Poisson GAM visualization.
    """
    with patch('gen_imgs.plt.savefig') as mock_savefig:
...
def test_default_data_logistic():
    """
    Test that default_data_logistic function executes without error and calls plt.savefig
    with the correct filename and dpi parameters for logistic GAM visualization.
    """
    with patch('gen_imgs.plt.savefig') as mock_savefig:
...
def test_chicago_tensor():
    """
    Test that chicago_tensor function executes without error and calls plt.savefig
    with the correct filename and dpi parameters for Chicago dataset tensor visualization.
    """
    with patch('gen_imgs.plt.savefig') as mock_savefig:
