...
![alt tag](http://latex.codecogs.com/svg.latex?g(\\mathbb{E}[y]) = \\beta_0 + f_1(X_1) + f_2(X_2) + \\dots + f_p(X_p))
...
![alt tag](http://latex.codecogs.com/svg.latex?g(\\mathbb{E}[y]) = log(\\frac{P(y=1|X)}{P(y=0|X)}))
